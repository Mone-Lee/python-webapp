...
import logging
from re import template; logging.basicConfig(level=logging.INFO)
...
async def init(loop):
    await orm.create_pool(loop=loop, host='127.0.0.1', port=3306, user='lee', password='lee', db='python_webapp')
